...
// Whichever domain is verified in Resend has to match this address, or every
// send comes back 403. Override with EMAIL_FROM.
const DEFAULT_FROM = "Launch Point Global Tour <josh@launchpointsim.com>";
